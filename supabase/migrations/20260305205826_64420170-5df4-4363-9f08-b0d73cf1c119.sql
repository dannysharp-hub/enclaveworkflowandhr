...
-- Update cab_handle_event_transition to:
-- 1) On install.complete: also emit customer.signoff.requested and set awaiting_signoff
-- 2) On customer.signoff.completed: use milestone='completion' and set practical_completed
-- 3) On invoice.paid with milestone='completion': close the job
